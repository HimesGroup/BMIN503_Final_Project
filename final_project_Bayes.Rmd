...
AQI.outcomes.final %>% dplyr::filter(pm2.5_flag10_ungreen==1) %>% summary()
AQI.outcomes.final %>% dplyr::filter(pm2.5_flag20_ungreen==1) %>% summary()
...
AQI.ACS.geom <- inner_join(AQI.ACS,geom.joinready2,by="GEOID") %>% group_by()
head(AQI.ACS.geom)
```
...
rf.flag10.ungreen <- randomForest(
  factor(pm2.5_flag10_ungreen) ~ 
    # Create these FLAGs as factors to start
               age.median + commute.time.agg.10k + income.hh.median.10k + rent.median.100 
             + home.pmt.median.100 + race.black.any + ethn.nhisp.white.alone + married + kids 
             + bachelor.plus + veteran + manufacturing + farm.fish.mining + commutes.car.alone 
             + renter + single.fam.home + worked.12mo + poverty.12mo + snap.12mo
...
rf.flag20.ungreen <- randomForest(
  factor(pm2.5_flag20_ungreen) ~ 
    # Create these FLAGs as factors to start
               age.median + commute.time.agg.10k + income.hh.median.10k + rent.median.100 
             + home.pmt.median.100 + race.black.any + ethn.nhisp.white.alone + married + kids 
             + bachelor.plus + veteran + manufacturing + farm.fish.mining + commutes.car.alone 
...
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = manufacturing)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = worked.12mo)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = race.black.any)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = ethn.nhisp.white.alone)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = farm.fish.mining)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag10_ungreen), y = snap.12mo)) +
    geom_violin(fill = "springgreen1", draw_quantiles = c(0.25, 0.5, 0.75)) 

ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag20_ungreen), y = worked.12mo)) +
    geom_violin(fill = "steelblue1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag20_ungreen), y = ethn.nhisp.white.alone)) +
    geom_violin(fill = "steelblue1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag20_ungreen), y = income.hh.median.10k)) +
    geom_violin(fill = "steelblue1", draw_quantiles = c(0.25, 0.5, 0.75)) 
ggplot(data = AQI.ACS.geom, aes(x = factor(pm2.5_flag20_ungreen), y = bachelor.plus)) +
    geom_violin(fill = "steelblue1", draw_quantiles = c(0.25, 0.5, 0.75)) 
```
