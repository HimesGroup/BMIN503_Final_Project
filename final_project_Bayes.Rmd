...
Get the census variable list to select from. 
...
View(census.1yr.vars)

# Look at questionnaire PDF - select ~20-25 Qs of interest
# .. Age (mean / median)
# .. % (Non-)Hispanic/Latino (any origin)
# .. % Black, % American Indian -- or % White?
# 4. Household size?
...
# 13. % any military service
# 14. % worked for pay last week (at a job or otherwise)
#  >>> FT employed 50+ weeks in the past year
# .. Got to work by car/truck/van
# 16. Commute time
# .. % Manufacturing work
# .. Total Income? Total Wages? >>> Poverty status
# 
# 
# 
# 
...
Test pulling and linking 1 census variable to the testing site file. 
...
acs.loop <- function(){
  for (st in seq_along(lower48.codes)) {
    ...
    results.acs <- get_acs( geography = "tract"
                          ,variables=c("B08101_001","B08101_002")
                          ,state = newstate
                          ,county = county.list
                          ,output = "wide")
