...
seer$psbgroup[seer$sex == "Male" & seer$part == "Single" & seer$group == "Male Genital Organs"] <- 17
...
seer$psbgroup[seer$sex == "Male" & seer$part == "Partnered" & seer$group == "Male Genital Organs"] <- 41
