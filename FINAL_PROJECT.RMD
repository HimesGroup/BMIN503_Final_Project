...
#### 4.2 Causal Impact analysis of number of transplants
...
#### 4.3 Effect of the COVID-19 pandemic on the number of lung transplants done
...
tab_model(lungtx_covid_lm_totalcases, lungtx_covid_lm_newcases, lungtx_covid_lm_totalhosp, lungtx_covid_lm_totalicu, lungtx_covid_lm_all, digits = 8, collapse.ci=TRUE, pred.labels = TRUE)
```
...
#### 4.4 Effect of the COVID-19 pandemic on the duration spent on waitlist
