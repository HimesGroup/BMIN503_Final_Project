...
-   Find monthly COVID-19 rates in US
...
-   Linear regression model to see if there is a relationship between COVID-19 infection rate and lung transplant
...
\`\`\`{r eval = TRUE} library(ggplot2) library(ggpubr) library(plotly)

require(ggplot2) ggplot(A, aes(Dates, GasDiff)) + geom_line( aes(colour = Year))
