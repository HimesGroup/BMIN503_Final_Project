...
ptt.df<-chopdf.ii
  ...
  for(i in 1:K){
      ...
      #RF train/test
      rf <- randomForest(PTT ~(FactorVIII)+(FactorXI)+(FactorIX)+(FactorXII)+FactorV+FactorII,ntree=100, data=train,na.action = na.omit)
