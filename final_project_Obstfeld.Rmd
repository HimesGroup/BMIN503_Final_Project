...
table(quantcut(as.matrix(penndf)[,12]))
ggplot(penndf)+
  geom_boxplot(aes(x=quantcut(penndf$'Factor VII',na.rm = TRUE),y=PT))
...
grid.arrange(bxpt[[3]], 
             ...
             bxpt[[10]],
             bxpt[[11]],
             nrow=3, ncol=3,top="Distribution of data values",  bottom="Figure 1")
