...
Top 5 more likely to be in cases. Correlation not causation. But I'd conduct due diligence if it was my fam...

```{r}
model <- glm(status ~ top_5_percentile_admin_change + for_profit + average_number_of_residents_per_day.x + adjusted_total_nurse_staffing_hours_per_resident_per_day.x + chow.y, family=binomial, final.df)
summary(model)
```
