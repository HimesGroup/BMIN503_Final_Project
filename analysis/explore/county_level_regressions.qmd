...
Drop in ACO's in 2019. So why did VBC pene increase in this year? So why did VBC pene increase in this year? Is COVID impactful?
...
State / year fixed effects should prove influential for two reasons:
- Regulatory environment varies by state and year.
- COVID had a differential impact depending on statewide policies and cultural norms regarding vaccination.
