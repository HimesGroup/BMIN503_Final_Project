...
During the pre-vaccination period, mobility demonstrated a positive association with the GR of COVID-19 ($\beta$ = 0.09, 95% CI: 0.06 to 0.13). This suggests that restricting mobility could potentially reduce the spread of COVID-19 (see @fig-mobility_earl_meta).

Conversely, during the post-vaccination period, this relationship reversed, showing $\beta$ = -0.05 (95% CI: -0.09 to -0.02). This indicates that mobility restrictions during this phase might not be as effective and could potentially increase the spread of COVID-19 (see @fig-mobility_late_meta).
