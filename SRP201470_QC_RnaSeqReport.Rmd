---
title: 'RNA-Seq Report of Sample QC and Alignment Summary Statistics for SRP201470'
...
path.start="/projects/RNASeq/SRP201470/SRP201470_Alignment_QC_Report_star/"
sample.names.orig <- c('SRX6072819', 'SRX6072820', 'SRX6072821', 'SRX6072822', 'SRX6072823', 'SRX6072824', 'SRX6072825', 'SRX6072826', 'SRX6072827', 'SRX6072828', 'SRX6072829', 'SRX6072830', 'SRX6072831', 'SRX6072832', 'SRX6072833', 'SRX6072834', 'SRX6072835', 'SRX6072836', 'SRX6072837', 'SRX6072838', 'SRX6072839', 'SRX6072840', 'SRX6072841', 'SRX6072842', 'SRX6072843', 'SRX6072844', 'SRX6072845')
sample.names <- sample.names.orig
ercc.mixes=c('-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-')
genome="mm10"
library_type="PE"
aligner="star"
sample_info_file='/projects/RNASeq/SRP201470/files/SRP201470_Phenotype_withoutQC.txt'
count_data_file='/projects/RNASeq/SRP201470/SRP201470_Alignment_QC_Report_star/SRP201470_htseq_gene.txt'
ambion_file <- '/home/chay/template_dir/ERCC_SpikeIn_Controls_Analysis.txt'
ercc.data <- read.table('SRP201470_htseq_ercc.txt', sep='\t', header=T, as.is=T)
```
...
nofeature.data <- read.table('SRP201470_htseq_nofeature.txt', sep='\t', header=T, as.is=T)
