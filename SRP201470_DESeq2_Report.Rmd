---
title: 'Differential Expression Results for SRP201470'
author: Ceire Hay (ceirehay@pennmedicine.upenn.edu)
...
> SRP201470_QC_RnaSeqReport.html<br>
...
> SRP201470_counts_normalized_by_DESeq2.txt<br>
...
> SRP201470_CASE_vs_CONTROL_DESeq2_results.txt<br>
...
path.start='/projects/RNASeq/SRP201470/'
...
fav_genes <- c('Il6', 'Tgfb', 'Saa1', 'Saa2', 'Saa3', 'Saa3', 'Saa4', 'Il7a', 'IL17f', 'Ccr6', 'Cd161', 'Il23r', 'Ccl20', 'Rorc', 'Stat6', 'Gata3', 'Cdr4', 'Crth2', 'Il4', 'Il5', 'Il13', 'Ctla4', 'Pd1', 'Tim3', 'Lag3', 'Tigit')
fav_list <- list()
coldata <- read.table('/projects/RNASeq/SRP201470/files/SRP201470_Phenotype_withQC.txt', sep='\t', header=TRUE)
...
mart <- useMart(biomart='ENSEMBL_MART_ENSEMBL', host='mar2016.archive.ensembl.org', path='/biomart/martservice' ,dataset='mmusculus_gene_ensembl')
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		...
		cat('Samples with Donor==', i, 'were removed from the IL6_TGFb_3 vs. IL6_3 comparison because there was an unequal number of case and control samples')
}
}
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_TGFb_12 vs. IL6_12 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_TGFb_48 vs. IL6_48 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_3 vs. IL6_3 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_12 vs. IL6_12 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_48 vs. IL6_48 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_3 vs. IL6_TGFb_3 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_12 vs. IL6_TGFb_12 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
...
for (i in unique(coldata_curr$Donor)) {
	if (!(i%in%donors_case&i%in%donors_ctrl)) {
		coldata_curr <- coldata_curr[-which(coldata_curr$Donor==i),]
		cat('Samples with Donor==', i, 'were removed from the IL6_rmSAA1_48 vs. IL6_TGFb_48 comparison because there was an unequal number of case and control samples')
}
}
coldata_curr <- coldata_curr[order(as.character(coldata_curr$Sample)), ]
coldata_curr$Status <- factor(coldata_curr$Status, levels = c(ctrl,case)) # make sure that control is being used as reference level (else DESeq2 does it alphabetically)
