...
sorted_df <- final_df[order(final_df$frequentist_add_pvalue),]
...
Manhattan plot (chr19) indicates significant hits of SNPS with Lowest P-value of 8.4x10-54 Chr19 at around 45Mb (APOE region). 
