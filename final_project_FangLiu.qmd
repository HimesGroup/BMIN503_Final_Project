...
ggplot(total_cases, 
  ...
  labs(title = "Top 10 diseases by case count (CA; 2001- 2021)", 
...
Add comparison cholorpleth for year 2001 vs. 2019 --> to show the increase. 

Connect some socioeconomic data or Separte analysis by sex? 
