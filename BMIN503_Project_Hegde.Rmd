...
Next, let us look at a heat map of the percentage change by state over the 12 years.
...
#+ geom_ribbon(data = data.total.1.predict, mapping = aes(ymin = lwr, ymax = upr, x = year), fill = "red", alpha = 0.2) #in the middle not 
#Indentation?
