...
ggplot(corr_mat_unique, aes(x=Var1, y=Var2, fill=low)) +
  geom_tile()

ggplot(corr_mat_unique, aes(x=Var1, y=Var2, fill=medium)) +
  geom_tile()

ggplot(corr_mat_unique, aes(x=Var1, y=Var2, fill=high)) +
  geom_tile()

ggplot(corr_mat_unique, aes(x=Var1, y=Var2, fill=value)) +
  geom_tile()
```
