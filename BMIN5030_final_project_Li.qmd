...
On GISAID, I searched for human influenza A and influenza B viruses collected in the United States from October 2010 to October 2019. For the selection criteria, I only wanted entry that has a full hemagglutinin and neuraminidase. I downloaded the virus metadata.
...
gisaid <- gisaid |>
            dplyr::select(c("Isolate_Id", "Isolate_Name", "Subtype", "Clade", "Collection_Date"))
