...
### because login credentials are required to connect to the Socrata Open Data API (SODA),
# the file has already been downloaded
### file exceeded GitHub's file size limit, so it was restricted to Pennsylvania,
# New Jersey, and Delaware in a previous step
