...
### In the absence of Socrata API login credentials, import the file directly
cdc_vacc <- read_csv("cdc_vaccinations_in_the_united_states_county.csv.gz")

# ### connect to the Socrata Open Data API (SODA)
# 
# # login credentials for SODA
