...
county_agg <- county_new %>% 
  ...
  summarize(vacc_incidence_n = mean(new_vaccinations), # new fully vaccinated ind.                     
            mean_per_pop_fully_vacc = mean(fully_vacc_per_pop), # per pop vaccinated 
            mean_fully_vacc_n = mean(fully_vaccinated)) %>% # cum. fully vaccinated
