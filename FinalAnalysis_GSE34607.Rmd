...
For the selected pathways, the NES and padj values of all different combinations are plotted into a barplot for more detailed comparison. The signifcantly altered pathways are marked with * in the barplot.
