...
pheatmap(mat, 
         ...
         border_color = "grey", 
       #  gaps_col = c(4, 8, 10, 13, 17, 21, 23, 25, 28, 32, #I manually determined where it would make sense to split up the columns into groups and added gaps in those positions
        #              36, 40, 44, 48, 50, 54, 58, 62, 66, 70, 
         #             72, 75, 79),
         color = colorRampPalette(c("white","black"))(150),
         #annotation_col = annotations[,1:2], #Only want to annotate based on 2 of the variables in the annotation dataframe
...
rownames(annotation) <- annotation$Study_ID
annotation <- droplevels(annotation) 
annotation <- as.data.frame(annotation)

ann_colors <- highuse = c("highuse" = "#08306b",
                          "not_highuse" = "#e41a1c")
#check
