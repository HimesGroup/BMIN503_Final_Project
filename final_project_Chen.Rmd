...
ggplot(by_loc, aes(Location,count)) +
  geom_boxplot() +
  theme_bw() + 
  theme(panel.grid.major=element_line(colour="gray")) +
  theme(axis.text.x = element_text(colour="black",angle=90, hjust=1)) +
...
ggplot(bc_30d_ID, aes(x=count)) +
  ...
  scale_x_continuous(expand=c(0,0)) +
  labs(x="Number of blood cultures/patient", y="Count",
       title="Total number of sets taken per patient within a 30d period") +
...
ggplot(bc_30d_ID20, aes(x=count)) +
  ...
  scale_x_continuous(expand=c(0,0)) +
  labs(x="Number of blood cultures/patient", y="Count",
       title="Total number of sets taken for patients with at least 20 sets within a 30d period") +
...
ggplot(highuse_loc,aes(reorder(Location,-prop_highuse),
  ...
  labs(x="Location", 
       ...
       title="Location of high utilizers") 
...
ggplot(sigIsolate,aes(reorder(Final_Report,-num_set_postPosID),num_set_postPosID)) +
  ...
  labs(x="Isolate", 
       y="Number of follow-up cultures",
       title="Number of follow-up cultures for significant pathogens in model")
...
ggplot(top20,aes(reorder(Final_Report,-num_set_postPosID),num_set_postPosID)) +
  ...
  labs(x="Isolate", 
       y="Number of follow-up cultures",
       title="Number of follow-up cultures for top 20 pathogens")
