...
NH_clean <-IST_nh %>% #Create a new data set with outcome variables and only pertinent data
  ...
  dplyr::select(-(HOSPNUM:RDELAY), -(RATRIAL:RASP3), -(RDEF1:RDEF8), -(RDATE:DALIVE), -(DPLACE:DEAD8), -(HTI14:NCB14)) %>% #removing columns not pertinent
  rename(HospLOS=DALIVED, Cerebralbleed14=H14, Ischemic14=ISC14, IndetermStroke14=NK14, Stroke14=STRK14)
