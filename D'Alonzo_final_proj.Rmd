...
Finally, I was interested in examining how these LOAD, EXPLODE, DRIVE variables were associated with Injury Risk Score as an outcome variable. Below, I plot each measure by Injury Risk Score.
```{r}
