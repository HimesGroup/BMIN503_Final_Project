---
title: 'RNA-Seq Report of Sample QC and Alignment Summary Statistics for Lung_AT2'
...
nofeature.data <- read.table('Lung_AT2_htseq_nofeature.txt', sep='\t', header=T, as.is=T)
