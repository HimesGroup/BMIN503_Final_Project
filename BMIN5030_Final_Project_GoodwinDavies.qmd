...
indiv_combined_dataset <- smart_2021 |>
  mutate(
    ...
    d_ever_smoker = case_when(d_smoker3 %in% c(1, 2, 3) ~ 1,
                               d_smoker3 == 4 ~ 0,
                               TRUE ~ NA),
    d_ever_asthma = case_when(d_ltasth1 == 1 ~ 0,
                               d_ltasth1 == 2 ~ 1,
                               TRUE ~ NA),
...
smoking_quasibinom <-
  glm(w_ever_smoker ~ county_adi_value + RPL_THEME1 + RPL_THEME2 + RPL_THEME3 + RPL_THEME4,
      family = quasibinomial(),
      data = smoking_dataset_cleaned)

smoking_quasipoisson <-
  glm(
    n_w_ever_smoker ~ county_adi_value + RPL_THEME1 + RPL_THEME2 + RPL_THEME3 + RPL_THEME4,
    offset = log(county_ct),
    family = quasipoisson(link = "log"),
    data = smoking_dataset_cleaned
  )
...
asthma_quasibinom <-
  glm(w_ever_asthma ~ county_adi_value + RPL_THEME1 + RPL_THEME2 + RPL_THEME3 + RPL_THEME4,
      family = quasibinomial(),
      data = asthma_dataset_cleaned)

asthma_quasipoisson <-
  glm(
    n_w_ever_asthma ~ county_adi_value + RPL_THEME1 + RPL_THEME2 + RPL_THEME3 + RPL_THEME4,
    offset = log(county_ct),
    family = quasipoisson(link = "log"),
    data = asthma_dataset_cleaned
  )
...
indiv_combined_corr_plot <- indiv_combined_dataset |>
  select(-d_sex, -d_race_eth, -d_imput_age_group, -d_mmsa) |> 
  get_corr_plot()
...
smoking_binomial_adi_only <-
  glm(
    d_ever_smoker ~ mmsa_adi_value + d_sex + d_race_eth + d_imput_age_group,
    family = binomial(),
...
smoking_binomial <-
  glm(
    d_ever_smoker ~ mmsa_adi_value + mmsa_RPL_THEME3 + d_sex + d_race_eth + d_imput_age_group + mmsa_RPL_THEME1 + mmsa_RPL_THEME2 + mmsa_RPL_THEME3 + mmsa_RPL_THEME4,
    family = binomial(),
    data = smoking_individual_dataset_cleaned
  )
...
asthma_individual_dataset_cleaned <- indiv_combined_dataset |>
  filter(!is.na(d_ever_asthma))

asthma_binomial_adi_only <-
  glm(
    d_ever_asthma ~ mmsa_adi_value + d_sex + d_race_eth + d_imput_age_group,
    family = binomial(),
...
asthma_binomial <-
  glm(
    d_ever_asthma ~ mmsa_adi_value + mmsa_RPL_THEME3 + d_sex + d_race_eth + d_imput_age_group + mmsa_RPL_THEME1 + mmsa_RPL_THEME2 + mmsa_RPL_THEME3 + mmsa_RPL_THEME4,
    family = binomial(),
    data = asthma_individual_dataset_cleaned
  )
