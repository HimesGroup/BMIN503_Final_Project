...
#Calculated Body Mass Index	SEX, WEIGHT2, HEIGHT3	HTIN4, HTM4, WTKG3	_BMI5 -- _LLCPWT (adjusted weight)
#Four level weight variable (normal, overweight, obese) based on Body Mass Index	SEX, WEIGHT2, HEIGHT3	HTIN4, HTM4, WTKG3, _BMI5	_BMI5CAT
#BRFSS uses this scale to adjust weights - I guess would still be same for BMI as it is linear for weight?
...
splots2[[2]] <- ggsurvplot(km_fit_BMIage,
           conf.int=TRUE,
           pval=TRUE,
           risk.table=FALSE,
...
splots2[[3]] <- ggsurvplot(km_fit_BMIsex,
           conf.int=TRUE,
           pval=TRUE,
           risk.table=FALSE,
...
splots2[[4]] <- ggsurvplot(km_fit_BMIECOG,
           conf.int=TRUE,
           pval=TRUE,
           risk.table=FALSE,
...
ggsurvplot(km_fit_BMIEBW_binary,
           conf.int=TRUE,
           pval=TRUE,
           risk.table=FALSE,
           legend.labs=c(">30", "<30"), 
