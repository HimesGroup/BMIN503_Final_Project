...
***
### Overview
Race influences many aspects of ones life from culture and lifestlye to health outcomes, especially between Caucasian people and minorities, or people of color (POC). I'm interested to see if these health disparities exist in the greater Philadelphia region and what factors are the greatest predictors of adverse health events. I will be applying statistical and machine learning analysis to the Southeastern Pennsylvania Household Survey results from 2015 to evaluate the difference between white people and POC. You can get access to my Github repository [here](https://github.com/joycehelenwang/BMIN503_Final_Project).
...
The data I am analyzing is from the 2014-2015 Southeastern Pennsylvania Household Health Survey with results from adults and children combined. After loading in the data, it'll be cleaned accordingly. First and foremost, the entires will be classified based on race. Afterwards, relevant variables will be cleaned so that the responses are renamed to useful information.
