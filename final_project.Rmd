...
```{r}
#Read in data
Math <- fread(input = "https://raw.githubusercontent.com/clairezhu0421/BMIN503_Final_Project/master/raw\ data/student-mat.csv", sep = ",", header = T)
Portuguese <- fread("https://raw.githubusercontent.com/clairezhu0421/BMIN503_Final_Project/master/raw data/student-por.csv", sep = ",", header = T)
