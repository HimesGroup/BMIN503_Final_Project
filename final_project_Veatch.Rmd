...
ggplot(data=ASDvsRandomGeneAttributes, aes(x=variable, y=value, fill=Gene)) + 
      ...
      annotate("text",x = 1, y = 0.98, label='p=4.23e-09', cex = 5, parse=F) +
      annotate("text",x = 2, y = 0.15, label='p=3.68e-02', cex = 5, parse=F) +
      annotate("text",x = 3, y = 0.20, label='p=5.21e-16', cex = 5, parse=F)
```
