---
title: 'RAVED: Differential Expression Analysis for Gene Expression Microarry Data -- GSE34607 Outdoor vs Control at 10h'
...
Manually change the variables for GEO ID (geo_id), data directory (datadir), result directory (resdir), tissue, disease/treatment status, and comparison conditions
...
# reference condition
con0="control_10h" # naming is rigid, should be same as the Treatment defined in QC
# altered condition
con1="OutdoorExposure_10h" # naming is rigid, should be same as the Treatment defined in QC
