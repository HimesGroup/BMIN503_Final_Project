---
title: "County-Level Dynamics and Predictors of Opioid Overdose in the United States (2015-2020)"
author: "Chris Miller"
output:
  html_document:
    theme: flatly 
...
ggplot(vsrr.us.plot, aes(x=Time, y=`Number of Deaths`, colour=`Opioid Type`)) +
  geom_line(size=1.5) + theme_classic() + labs(title = "Opioid Overdose Death Rate by Opioid Type (2015-2020)")
...
To facilitate interpretability, all variables were scaled to represent 5 percentage-point increases in county-level prevalence in all models. The variables that predicted the greatest amount of variance in univariable linear regression models were _Depression_ ($R^{2}$=20.3%, 5 percentage point increase ass)
