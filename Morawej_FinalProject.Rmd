...
>   https://github.com/sem-22/BMIN503_Final_Project
...
>   As of today, the NSFG does not have downloadable files available for use in RStudio; nevertheless, the data were imported into R by creating a .dta outfile in STATA and then read into R through the appropriate "Import Dataset" feature.
...
birth.outcome.glm <- glm(birth.outcome ~ mom.age + cigs.per.day, race, hispanic, prenatal.care, delivery.payment.type, data = clean_nsfg, 
                  family = binomial())
...
> personal access token:  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 