...
df <- merged_df[, c("alt", "alb","alp", "ast", "urea", "cr", "ggt", "ldh", "na", "tbil", "chol", "tg", "etoh", "fibroscan_meanstiffness_kpa", "ha1c", "fibroscan_stiffnessiqr", "fibroscan_cap", "hc_self_cpiqr", "insurance_covered","demo_gender", "demo_age" , "demo_race", "demo_education", "body_bmi", "hb_self_reported", "hb_self_reported_treated", "hc_self_reported", "hc_self_reported", "hc_self_reported_treated", "hbcore_positive", "hbsag_positive", "hcrna", "hcab", "hcgenotype", "fibroscan_steatosis", "fibroscan_cirrhosis")]
...
df$fibroscan_steatosis

str(df$fibroscan_steatosis)
...
model_steatosis_continuous <- glm(fibroscan_meanstiffness_kpa ~ alt + alb + alp + ast + urea + cr + ggt + ldh + na + tbil + chol + tg + etoh + ha1c +  insurance_covered + demo_gender + demo_age + demo_race + demo_education + body_bmi, data = df)



significant_steatosis_continuous_summary <- summary(model_steatosis_continuous) 

p_significant_steatosis_continuous <- tidy(model_steatosis_continuous)
