...
From the multiple data sets availabe from 2017-2020, we will be using the following files for the following: 1) demo_data; Demographic data 2) hepq_data; Hepatitis questionnaire data 3) lab_data; Lab data 4) dmq_data; dmq (diabetes questionnaire) data 5) a1c_data; a1c (diabetes lab) data 6) hepb_data; hepatitis b data 7) hepc_data; Hepatitis c data 8) fibroscan_data; Fibroscan (firbous elastography) data 9) insurance_data; nsurance data 10)alcohol_data; Alcohol data
