...
output: 
  html_document:
    ...
    highlight: tango
---
```{r set-options, echo=FALSE, cache=FALSE, collapse=TRUE}
options(width = 400)
```  
...
```{r Connection, include=FALSE, cache=TRUE, collapse=TRUE}
...
#### Importing data
```{r Data import, cache=TRUE, collapse=TRUE}
...
```{r Trimming/formatting, collapse=TRUE}
...
##### Joining data
```{r Joining diagnosis/procedures, collapse=TRUE}
...
```{r Joining admission/patient, collapse=TRUE}
...
```{r Importing delivery codes, collapse=TRUE}
...
```{r Delivery records, collapse=TRUE}
...
#### C-section codes
```{r Importing c-section codes, collapse=TRUE}
...
```{r C-section records, collapse=TRUE}
...
```{r Delivery + Csection as variables, collapse=TRUE}
...
```{r Age, collapse=TRUE, collapse=TRUE}
...
```{r Gender/Sex, collapse=TRUE, collapse=TRUE}
...
```
```{r Ethnicity, collapse=TRUE, collapse=TRUE}
