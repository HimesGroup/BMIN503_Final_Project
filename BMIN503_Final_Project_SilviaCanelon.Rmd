...
```{r Connection, include=FALSE, collapse=TRUE}
...
```{r GGPairs, warning=FALSE, collapse=TRUE}
...
```{r ADMISSION_TYPE, collapse=TRUE}
...
# ADMISSION_TYPEs EMERGENCY and URGENT were both positively associated with MORTALITY with p-value <2e-16
```
