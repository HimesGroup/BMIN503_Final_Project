...
### The data used here requires an IRB. Please see the Rmd file that uses simulated data (File has "fake" in title) data to see the code run.Thus, the descriptions of the figures and results will match but will not in the simulated data Rmd file since it is simply just to show the code will run.
