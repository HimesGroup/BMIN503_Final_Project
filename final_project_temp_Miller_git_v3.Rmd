...
###THE DATA USED HERE REQUIRES THE USER TO BE ON AN IRB. PLEASE SEE THE Rmd FILE THAT USES SIMULATED (FILE NAME HAS "FAKE" IN TITLE) DATA TO SEE THE CODE RUN. THE DESCRIPTIONS WILL MATCH THE FIGURES AND RESULTS IN THIS FILE WHERE AS THEY WON'T IN THE FILE WITH SIMULATED DATA.
