...
**Age distribution is as follows**: 18--24 (N=1160, 8.2%), 25--34 (N=2198, 15.5%), 35--44 (N=2913, 20.5%), 45--54 (N=2871, 20.2%), 55--64 (N=2672, 18.8%), and 65 + (N=3231, 46.0%).

**The most dominant education group was people with some college** (N=3027, 21.3%) followed by bachelor's degree (N=2559, 18.0%).

**Race/ethnicity:** The study data predominantly includes White (N=11,338, 83.5%) followed by Black or African American (N=1275, 9.4%).

**Two groups were formed** to identify VCUG patients (N=204, 61%) and non-VCUG controls (N=130, 39%).

**Source distribution**: My survey source distribution is well-distributed, which is encouraging. It should be noted (this analysis was performed manually in Excel due to the nature of free-form entries) that nearly every respondent who discovered this survey via Reddit found it through the subreddit r/VCUGTrauma or a related medical trauma subreddit. This suggests a heavy amount of trauma-leaning bias in the sample.
