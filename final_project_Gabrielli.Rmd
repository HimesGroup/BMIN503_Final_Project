...
6 month Survival: All models predicting 6 month survival had a moderate-fair performance (Figure 4a,4b)(Table 2). The Logistic Regression model using top variables performed slightly better than other models with an AUC of 0.67. There is evidence for overfitting in both models of random forests as shown by the large difference between the AUC of the training versus testing data. Age, Total Anterior Stroke, No/Unknown Dysphagia were all significantly associated with increase chance of dying, while increased hospital length of stay and full consciousness at time of randomization where significantly associated with surviving at 6 months. Table 3 shows the p values for these variables. 

Final Living Place: All models predicting 6 month survival had a moderate performance (Figure 5a,5b)(Table 4). The Logistic Regression model using top variables again performed slightly better than other models with an AUC of 0.7135. There is evidence for overfitting in both models of random forests as shown by the large difference between the AUC of the training versus testing data. Age, hospital length of stay, total anterior stroke, no/unknown dysphagia were all significantly associated with remaining in a nursing home in the logistic regression model (Table 5).

Final Functional OUtcome: All models predicting 6 month survival had a moderate-fair performance (Figure 6a,6b)(Table 6). The Logistic Regression model using top variables again performed slightly better than other models with an AUC of 0.71. There is evidence for overfitting in both models of random forests as shown by the large difference between the AUC of the training versus testing data. Increased hospital length of stay and total anterior stroke were both significantly associated with being in a dependent state in the logistic regression model (Table 7)
