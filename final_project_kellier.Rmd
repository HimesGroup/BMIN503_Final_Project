...
dt_train <- filter(dt, dt_assignments == 1)
dt_test <- filter(dt, dt_assignments == 2)
...
dt_predictors_noNA <- dt_predictors[!is.na(dt_train$outcome_measured), ]
outcome_measured_noNA <- dt_train$outcome_measured[!is.na(dt_train$outcome_measured)]
propensity_weight_noNA <- dt_train$propensity_weight[!is.na(dt_train$outcome_measured)]
