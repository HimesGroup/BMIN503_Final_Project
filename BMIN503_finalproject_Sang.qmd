...
This project explores whether a random forest model using age, insurance status, gender, and race/ethnicity, and other pertinent variables can predict **1.)** 30-day readmissions and **2.)** in-hospital mortality and discharge to hospice among hospitalized patients with pulmonary hypertension (PH). Both training data only and 10-fold CV were used. I included all predictors and top 5 predictors. Data analysis was done using the MIMIC-IV dataset. I would like to acknowledge Lea Ann Matura, PhD, RN (associate professor within School of Nursing) and Jiyoun Song, PhD, RN (post-doctoral fellow within School of Nursing) for their invaluable feedback as I completed this project.
...
Perhaps different machine learning approaches are needed to more accurately predict 30-day readmission and in-hospital death/ discharge to hospice. These different approaches include, but are not limited to, logistic regression, X-G boost, and Recurrent Neural Networks.
