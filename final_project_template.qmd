...
# Check the data type of TaskORVideo
class(pos_by_measure_pre_integer$TaskORVideo)

# If it's integer, change to numeric; it must be numeric or it turns everything to "video". Once it's numeric, recode it to be 1 or 2 
pos_by_measure_pre_integer$TaskORVideo <- as.numeric(pos_by_measure_pre_integer$TaskORVideo)
...
neg_by_measure_pre_integer <- read.csv("/Users/saraig/Documents/Cure Study R/neg_by_measure_pre_integer.csv")

view(neg_by_measure_pre_integer)

# Check the data type of TaskORVideo
class(neg_by_measure_pre_integer$TaskORVideo)

# If it's integer, change to numeric; it must be numeric or it turns everything to "video". Once it's numeric, recode it to be 1 or 2 
neg_by_measure_pre_integer$TaskORVideo <- as.numeric(neg_by_measure_pre_integer$TaskORVideo)
