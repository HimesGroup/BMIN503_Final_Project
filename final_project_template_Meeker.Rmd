...
Next we needed to pull in data from Penn. Since this is PHI data, I am ommitting the initial code used to import the data. 

```{r}
#However, first I imported the data, then I merged a dataset of women with encounters with UPHS, and the lats and longs of their addresses, with a dataset that had outcome data for their deliveries. These variables include information about stillbirth, preterm birth, preeclampsia, hypertnesion and c-section. 
...
#View(encounter_at_deliv_woutcomes)
...
#View(data.new.philly)
data.new.philly[which(data.new.philly$tract=="135"), ]
...
Histograms were generated to look at overall outcome counts
...
plot.roc(data$CSECTION, CSECTION.lasso.pred[ ,1])
