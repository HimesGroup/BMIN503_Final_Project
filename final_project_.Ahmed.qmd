...
| The mortality rates does not appear to vary by region. Additionally, no effect modification has been identified based on the assessed variables.This findings could be due to several factor. If socioeconomic condfitions outside of Addis Ababa are uniform acrosss regions, the risk factors with preterm births and mortality may mot vary. It may also be do to the sample size and power,as there is significant difference in participants based on region ( Addis Ababa N=3208, Amhara region N = 1019 , and Oromia region N= 692). Therefore, the findings might be influenced by data limitations.
