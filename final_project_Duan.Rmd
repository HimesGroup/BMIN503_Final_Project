...
>1. Use statisitcal and mathematical methods to analyze the COVID-19 spreading pattern in the past one year. 2. Use machine learning methods to make resonable prediction of COVID-19 spreading in the future one year.
...
growth.rate(TS.data, geo.loc=c("US",state))
```
